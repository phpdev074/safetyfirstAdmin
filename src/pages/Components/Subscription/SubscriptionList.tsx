...
import { createSubscription, deleteSubsciption, deleteUser, getSubscriptionList } from '../../../api/helper';
...
function SubscriptionList() {
    ...
    const handelDelete = async (id: any) => {
        try {
          ...
          if (confirm) {
            const response = await deleteSubsciption(`?id=${id}`)
        ...
        <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            ...
            <div className="max-w-full overflow-x-auto">
                <table className="w-full table-auto">
                    ...
                    <tbody>
                        {info && info?.data?.map((packageItem: any, key: any) => (
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p
                                        ...
                                        className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium cursor-pointer ${packageItem?.status === "active"
                                            ? 'bg-success text-success'
                                            : 'bg-danger text-danger'}`}
                                    >
                                        {packageItem?.status === "active" ? "Active" : "Inactive"}
                                    </p>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
