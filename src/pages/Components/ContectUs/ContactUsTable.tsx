...
import { getContactUsList } from '../../../api/helper';
...
function ContactUsTable() {
    ...
    const getContactData = async (page = 1, search = "") => {
        const response = await getContactUsList(`?limit=10&page=${page}&search=${search}`)
                            ...
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    ...
                                    <p className="text-black dark:text-white">
                                        {
                                            packageItem?.message
                                                ? packageItem?.message.split(' ').length > 20
                                                    ? packageItem?.message.split(' ').slice(0, 20).join(' ') + '...'
                                                    : packageItem?.message
                                                : ""
                                        }
                                    </p>
